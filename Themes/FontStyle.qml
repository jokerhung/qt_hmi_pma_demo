...
Item {
    ...
    FontLoader {
        ...
        source: "qrc:/assets/fonts/Font Awesome 5 Pro-Regular-400.otf"
    }

    FontLoader {
        id: fontAwesomeLight
        source: "qrc:/assets/fonts/Font Awesome 5 Pro-Light-300.otf"
    }


    FontLoader {
        id: fontAwesomeSolid
        source: "qrc:/assets/fonts/Font Awesome 5 Pro-Solid-900.otf"
    }

    FontLoader {
        id: contentFontLight
        source: "qrc:/assets/fonts/Nunito-Light.ttf"
    }

    FontLoader {
        id: contentFontBold
        source: "qrc:/assets/fonts/Nunito-Bold.ttf"
    }


    FontLoader {
        id: contentFontMedium
        source: "qrc:/assets/fonts/Nunito-Medium.ttf"
    }
