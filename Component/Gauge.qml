...
CircularGauge {
    ...
    property string textColor: "#01E6DE"
    property string valueColorSmall: "white"
    property string valueColorLarge: "#777776"
...
//            }
        ...
        tickmarkLabel:  Text {
            ...
            color: styleData.value <= gauge.value ? valueColorSmall : valueColorLarge
            antialiasing: true
        }

        tickmark: Image {
            source: "../assets/tickmark.svg"
